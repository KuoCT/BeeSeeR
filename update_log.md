...
## 2025/05/02
### **上傳版本 v3.0.2**
- Patch tkinter 元件適應微軟新注音輸入法中的按鍵 (替代方案)
- 評估全面移至 pyqt6 可行性 (工程浩大，暫時不執行)
...
## 2025/04/23
- prompt 指令集模組重新修改，新版模組命名為 persona，使用者自訂性能提升

## 2025/04/21
- 新增回復初始設定功能
- 新增自訂熱鍵功能
- 更新設定選單 (未完成)
- 嘗試加入 Google Vision API (預定)
- 新版 prompt 格式 (預定)
